...
//*
//* This variant uses the *external* CICS translator DFHECP1$
//* (avoids Integrated Translator PARMLIB member DFHAPIR dependency).
//*
//* Steps:
//*   1) TRANSL   - DFHECP1$ translates EXEC CICS statements
//*   2) COBOL    - IGYCRCTL compiles translated source + DB2 SQL (PARM=SQL)
//*   3) LKED     - Link-edit with CICS stub DFHELII and MQ CICS stub CSQCSTUB
//*   4) BIND     - Bind DB2 package (optionally plan)
//*
//* Source member:  Z88011.CBL(LIBMQCIC)
//* DBRM member:    Z88011.DBRMLIB(LIBMQCIC)
