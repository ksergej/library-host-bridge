CBL SQL OFFSET TEST NOXREF NOMAP
       ...
       01  WS-REQ-QUEUE       PIC X(48) VALUE 'LIB.REQ.TEST'.
       01  WS-REP-QUEUE       PIC X(48) VALUE 'LIB.REP.TEST'.
...
CALL 'MQCONN' USING WS-QMGR-NAME
                               ...
                               COMPCODE
                               REASON.
                      DISPLAY 'C: AFTER  MQCONN CC=' COMPCODE ' RC=' REASON ' HCONN=' HCONN.
IF COMPCODE NOT = MQCC-OK
           ...
           DISPLAY 'D: BEFORE MQOPEN REQ Q=[' WS-REQ-QUEUE ']'.
           ...
           CALL 'MQOPEN' USING HCONN
                               ...
                               COMPCODE
                               REASON.
                      DISPLAY 'E: AFTER  MQOPEN REQ CC=' COMPCODE ' RC=' REASON ' HOBJ-REQ=' HOBJ-REQ.
IF COMPCODE NOT = MQCC-OK
               DISPLAY 'MQOPEN REQ FAILED, REASON=' REASON
               GO TO MQ-DISCONNECT
           END-IF.

           DISPLAY 'F: BEFORE MQOPEN REP Q=[' WS-REP-QUEUE ']'.
           MOVE MQOD-VERSION-4 TO MQOD-VERSION.
           ...
           CALL 'MQOPEN' USING HCONN
                               ...
                               COMPCODE
                               REASON.
                      DISPLAY 'G: AFTER  MQOPEN REP CC=' COMPCODE ' RC=' REASON ' HOBJ-REP=' HOBJ-REP.
IF COMPCODE NOT = MQCC-OK
           ...
           DISPLAY 'H: BEFORE MQGET (NO-WAIT)'.
