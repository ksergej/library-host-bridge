...
//SYSIN    DD  DISP=SHR,DSN=Z86422.CBL(LIBMQTST)
//DBRMLIB  DD  DISP=SHR,DSN=Z86422.DBRMLIB(LIBMQTST)
...
//         DD  *
  ...
  NAME   LIBMQTST(R)
/*
//SYSLMOD  DD  DSN=Z86422.LOAD(LIBMQTST),DISP=SHR
//********************************************************************
//*  BIND DB2 PLAN                                                  *
//********************************************************************
//BIND     EXEC PGM=IKJEFT01,COND=(8,LT,LKED)
//STEPLIB  DD  DSN=DSND10.SDSNLOAD,DISP=SHR
//DBRMLIB  DD  DSN=Z86422.DBRMLIB,DISP=SHR
//SYSUDUMP DD  DUMMY
//SYSTSPRT DD  SYSOUT=*
//SYSPRINT DD  SYSOUT=*
//SYSTSIN  DD  *,SYMBOLS=EXECSYS
 DSN SYSTEM(DBDG)
 BIND PLAN(LIBPLAN) PKLIST(Z86422.*) -
      MEMBER(LIBMQTST) -
