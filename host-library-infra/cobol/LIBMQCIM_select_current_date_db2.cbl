CBL SQL NOXREF NOMAP NOOFFSET NOSOURCE
       ...
       01  WS-DB2-CURRENT-DATE      PIC X(10) VALUE SPACES.
       ...
       MAIN-SECTION.
           ...
           IF COMPCODE NOT = MQCC-OK
              ...
              STRING 'MQOPEN REQ FAIL2'        DELIMITED BY SIZE
       ...
       DB2-SMOKE-TEST.
           MOVE SPACES TO WS-DB2-CURRENT-DATE
           EXEC SQL
                SELECT CHAR(CURRENT DATE)
                  INTO :WS-DB2-CURRENT-DATE
                  FROM SYSIBM.SYSDUMMY1
           END-EXEC

           MOVE SQLCODE TO WS-SQLCODE-DISP
           STRING 'DB2 DATE='            DELIMITED BY SIZE
                  WS-DB2-CURRENT-DATE    DELIMITED BY SIZE
       ...
       EXTRACT-ACTIVE-USER-ID.
           ...
           IF WS-START >= LENGTH OF REQ-DATA
              EXIT PARAGRAPH
           END-IF
           COMPUTE WS-START = WS-START +
                              LENGTH OF WS-TAG-ACTIVE-USER-START
           INSPECT REQ-DATA
               TALLYING WS-END
